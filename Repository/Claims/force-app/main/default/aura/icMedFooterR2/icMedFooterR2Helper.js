...
({
    ...
    navToPrivacyPolicy : function (component) {
        this.doNav(component, "IKOROOFPRO_Privacy_Policy", "ikoroofpro-privacy-policy");

    },

    navToTermsConditions : function (component) {
        this.doNav(component, "IKOROOFPRO_Terms_Conditions", "ikoroofpro-terms-and-conditions");
    ...
    navToContactUs : function (component) {
        this.doNav(component, "IKOPRO_Contact_Us", "ikopro-contact-us");
