...
({
    ...
    */
    createTypeaheadComponent: function(component){
        ...
        },
		{
            ...
            source: function(q,cb){
				...
				compEvent.setParams({"searchString" : q, "type" : component.get('v.type') });
                compEvent.fire();
            },
        })
        //selects the element
        .bind('typeahead:selected', 
			function(evnt, suggestion){
                ...
                // Dispatching only the id and name keeps it so that the sObject can be anything
                // and leaves external components to decide what fields they need after the lookup
                // has been selected.
    ...
    searchAction : function(component, q){
        ...
        var self = this;
        var action = component.get("c.searchSObjectFiltered");
        action.setParams({
            'type' : component.get('v.type'),
            'searchString' : q,
